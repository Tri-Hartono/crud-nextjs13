        ...
        <div className="modal-box">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-control">
              ...
              <input type="text" className="input w-full input-bordered" placeholder="title" onChange={(e) => setTitle(e.target.value)} />
            </div>
            <div className="form-control">
              <label className="label font-d">Price</label>
              <input type="text" className="input w-full input-bordered" placeholder="Price" onChange={(e) => setPrice(e.target.value)} />
            </div>
